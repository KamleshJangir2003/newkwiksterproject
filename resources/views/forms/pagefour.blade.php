...
<head>
    ...
    <link rel="alternate" type="application/json+oembed"
        href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F241697029933466"
        title="oEmbed Form">
    <link rel="alternate" type="text/xml+oembed"
        href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F241697029933466"
        title="oEmbed Form">
    <link rel="shortcut icon" href="https://cdn.jotfor.ms/assets/img/favicons/favicon-2021-light%402x.png">
    <link rel="apple-touch-icon" href="https://cdn.jotfor.ms/assets/img/favicons/favicon-2021-light%402x.png">
    <link rel="canonical" href="https://form.jotform.com/241697029933466" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=2.0, user-scalable=1" />
    <meta name="HandheldFriendly" content="true" />
    <title>New CuFormstomer Registration </title>
...
" />
    ...
    <link type="text/css" rel="stylesheet"
        href="https://cdn02.jotfor.ms/themes/CSS/5e6b428acc8c4e222d1beb91.css?v=3.3.54752&themeRevisionID=5eb3b4ae85bd2e1e2966db96" />
    <link type="text/css" rel="stylesheet"
        href="https://cdn03.jotfor.ms/css/styles/payment/payment_styles.css?3.3.54752" />
    <link type="text/css" rel="stylesheet"
        href="https://cdn01.jotfor.ms/css/styles/payment/payment_feature.css?3.3.54752" />
    ...
    <script src="https://cdn02.jotfor.ms/static/prototype.forms.js?v=3.3.54752" type="text/javascript"></script>
    <script src="https://cdn03.jotfor.ms/static/jotform.forms.js?v=3.3.54752" type="text/javascript"></script>
    <script src="https://cdn01.jotfor.ms/js/vendor/imageinfo.js?v=3.3.54752" type="text/javascript"></script>
    <script src="https://cdn02.jotfor.ms/file-uploader/fileuploader.js?v=3.3.54752" type="text/javascript"></script>
    <script src="https://cdn01.jotfor.ms/s/umd/00f1603ff53/for-form-branding-footer.js?v=3.3.54752" type="text/javascript"
        defer></script>
    <script src="https://cdn03.jotfor.ms/js/vendor/smoothscroll.min.js?v=3.3.54752" type="text/javascript"></script>
    <script src="https://cdn01.jotfor.ms/js/errorNavigation.js?v=3.3.54752" type="text/javascript"></script>
</head>

<body>
    <form action="{{ route('page_four_store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div role="main" class="form-all">
            <ul class="form-section page-section">
                <li class="form-line" data-type="control_divider" id="id_16">
                    <div id="cid_16" class="form-input-wide" data-layout="full">
                        <div class="divider" data-component="divider"
                            style="border-bottom-width:1px;border-bottom-style:solid;border-color:#FFFFFF;height:1px;margin-left:0px;margin-right:0px;margin-top:5px;margin-bottom:5px">
                        </div>
                    </div>
                </li>
                ...
                <li id="cid_33" class="form-input-wide" data-type="control_head">
                    <div class="form-header-group  header-default">
                        <div class="header-text httac htvam">
                            <h2 id="header_33" class="form-header" data-component="header">J&amp;A Global Freight
                                Management LLC</h2>
                            <div id="subHeader_33" class="form-subHeader">Alexandria,VA, 22306 </div>
                        </div>
                    </div>
                </li>
                <li class="form-line" data-type="control_text" id="id_34">
                    <div id="cid_34" class="form-input-wide" data-layout="full">
                        <div id="text_34" class="form-html" data-component="text" tabindex="0">
                            <p>Thank you to provide us your basic information. We received your COI and Driving LIcense
                                picture.<br /><br />If you want to contact right away to our load onboarding manager then you
                                can call 24/7 on this number <a href="tel:571-253-9099">571-253-9099</a><br /><br /><strong>Required Documentation for
                                    onboarding process
                                    :</strong><br />( Once you provide all the documents, Onboarding
                                process will take 2-3 hours after the right away we can be able to provide you the Loads
                                )<br /><br /> <br />Complete W-9 a blank W-9 has been included for your
                                convinience <br />Copy of MC authority document<br />State
                                inspections report(If have)<br />IFTA stickers &amp; document(If have)<br />Truck
                                Registration<br /><br />NOTE: Above documents if you have right now, You can attach
                                them. This Link will expire in next 12 hours. So just
                                provide the documents which you have. First 50 customers will get special discounts on
                                the Load percent.<br /><br /><br /></p>
                        </div>
                    </div>
                </li>
                <li style="margin-bottom: 10px;">
                    Dot: <input type="text" name="dot" maxlength="7"
                         required />
                </li>
                ...
                <li class="form-line" data-type="control_fileupload" id="id_37"><label
                        ...
                        aria-hidden="false"> State inspections report(If have) </label>
                ...
                <li class="form-line" data-type="control_fileupload" id="id_38"><label
                        class="form-label form-label-top form-label-auto" id="label_38" for="input_38"
                        aria-hidden="false"> IFTA stickers &amp; document(If have) </label>
                        ...
                        <div class="jfQuestion-fields" data-wrapper-react="true">
                            <div class="jfField isFilled">
                                <div class="jfUpload-wrapper">
                                    ...
                                    <div class="jfUpload-files-container">
                                        <div class="validate[multipleUpload]"><input type="file" id="input_38"
                                                name="file4" multiple="" class="form-upload-multiple"
                                                data-imagevalidate="yes"
                                                data-file-accept="pdf, doc, docx, xls, xlsx, csv, txt, rtf, html, zip, mp3, wma, mpg, flv, avi, jpg, jpeg, png, gif"
                                                data-limit-file-size="Yes" data-file-maxsize="10854"
                                                data-file-minsize="0" data-file-limit="" data-component="fileupload"
                ...
                <li class="form-line" data-type="control_fileupload" id="id_39"><label
                        class="form-label form-label-top form-label-auto" id="label_39" for="input_39"
                        aria-hidden="false"> Truck Registration </label>
                        ...
                        <div class="jfQuestion-fields" data-wrapper-react="true">
                            <div class="jfField isFilled">
                                <div class="jfUpload-wrapper">
                                    ...
                                    <div class="jfUpload-files-container">
                                        <div class="validate[multipleUpload]"><input type="file" id="input_39"
                                                name="file5" multiple="" class="form-upload-multiple"
                                                data-imagevalidate="yes"
                                                data-file-accept="pdf, doc, docx, xls, xlsx, csv, txt, rtf, html, zip, mp3, wma, mpg, flv, avi, jpg, jpeg, png, gif"
                                                data-limit-file-size="Yes" data-file-maxsize="10854"
                                                data-file-minsize="0" data-file-limit="" data-component="fileupload"
                ...
                <li class="form-line" data-type="control_text" id="id_42">
                    <div id="cid_42" class="form-input-wide" data-layout="full">
                        <div id="text_42" class="form-html" data-component="text" tabindex="0">
                            <p><strong>NOTE : IF YOU HAVE SOME MORE DOCUMENTS AND YOU WANT TO SEND THEM TO US, YOU CAN
                                    JUST EMAIL US OR TEXT US.</strong><br /><br /><strong>EMAIL ADDRESS : <a
                                        href="mailto:SHAWN.KWIKLOADS@GMAIL.COM" target="_blank"
                                        rel="nofollow">SHAWN.KWIKLOADS@GMAIL.COM</a></strong><br /><strong>TEXT US ON
                                    : (571) 569-6646</strong></p>
                        </div>
                    </div>
                </li>
                <li class="form-line" data-type="control_textarea" id="id_41"><label
                        class="form-label form-label-top form-label-auto" id="label_41" for="input_41"
                        aria-hidden="false"> Comments : </label>
                    <div id="cid_41" class="form-input-wide" data-layout="full"> <span
                            class="form-sub-label-container" style="vertical-align:top">
                            <textarea id="input_41" class="form-textarea" name="comments" style="width:648px;height:163px"
                                data-component="textarea" aria-labelledby="label_41 sublabel_input_41"></textarea><label class="form-sub-label" for="input_41"
                                id="sublabel_input_41" style="min-height:13px">( If you have any kind of doubt or
                                questions, you can just ask here )</label>
                        </span> </div>
                </li>
