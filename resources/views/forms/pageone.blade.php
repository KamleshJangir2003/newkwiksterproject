...
<head>
    ...
    <link rel="alternate" type="application/json+oembed"
        href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F241695007511452"
        title="oEmbed Form">
    <link rel="alternate" type="text/xml+oembed"
        href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F241695007511452"
        title="oEmbed Form">
    <meta property="og:image"
        content="https://www.jotform.com/uploads/bryan75970/form_files/Screenshot%202024-06-19%20042254.66720fe2b2c0e7.83854125.png" />
    ...
    <link rel="canonical" href="https://form.jotform.com/241695007511452" />
...
" />
    ...
    <script src="https://cdn01.jotfor.ms/s/umd/00f1603ff53/for-form-branding-footer.js?v=3.3.54752" type="text/javascript"
        defer></script>
    <script src="https://cdn01.jotfor.ms/js/vendor/smoothscroll.min.js?v=3.3.54752" type="text/javascript"></script>
    <script src="https://cdn02.jotfor.ms/js/errorNavigation.js?v=3.3.54752" type="text/javascript"></script>
...
<body>
    <form class="jotform-form" action="#" method="post" accept-charset="utf-8" autocomplete="on">
        <div id="formCoverLogo" style="margin-bottom:32px"
            ...
            <div class="form-page-cover-image-wrapper" style="max-width:180px">
                <img src="{{ asset('uploads/logo.png') }}" class="form-page-cover-image" width="380" height="160"
                    aria-label="Form Logo" style="aspect-ratio:380/160" />
            </div>
            <div class="header-content" style="text-align: center">
                <p><strong>website : <a href="https://kdausalogistics.com/" target="_blank"
                            rel="nofollow">https://kdausalogistics.com/</a></strong></p>
                <p><strong>Call <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"width="14px"
                            height="14px"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                            <path
                                d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z" />
                        </svg>
                        : 804-392-9758</strong></p>
            </div>
        </div>
            ...
            <ul class="form-section page-section">
                <li id="cid_41" class="form-input-wide" data-type="control_head">
                    <div class="form-header-group  header-default">
                        <div class="header-text httac htvam">
                            <h2 id="header_41" class="form-header" data-component="header">KDA USA DISPATCH SERVICES
                            </h2>
                            <div id="subHeader_41" class="form-subHeader">7524 Richmond Highway Alexandria, VA 22306
                            </div>
                        </div>
                    </div>
                </li>
                <li class="form-line" data-type="control_text" id="id_43">
                    <div id="cid_43" class="form-input-wide" data-layout="full">
                        <div id="text_43" class="form-html" data-component="text" tabindex="0">
                            <p><br /><strong>"I am your dedicated personal assistant specializing in facilitating the
                                    onboarding process for Trucking Load."</strong><br /><strong>My desk number
                                    is (804)-392-9758.<br /><br />Booking loads—whether you’re running under a brand-new
                                    trucking authority or an established one—comes with its own set of challenges.
                                    <br /><br />For new authorities, many brokers may be hesitant to work with you until
                                    you’ve built a proven track record for reliability, safety, and on-time deliveries.
                                    <br /><br />For established authorities, competition, rate negotiations, and
                                    maintaining strong broker relationships remain ongoing challenges in securing the
                                    most profitable loads.<br /><br />
                                    Regardless of your experience level, the sheer number of load board options, market
                                    data, and the constant pressure to book the right freight can feel overwhelming
                                    without a solid strategy<br /><br />"Trucking Load: Streamlined logistics solutions
                                    tailored
                                    to maximize efficiency and minimize costs. With our robust network and dedicated
                                    service, we ensure seamless transportation for your cargo, delivering reliability
                                    you can count on."<br /></strong></p>
                        </div>
                    </div>
                </li>
                    ...
                    <div class="form-input-wide" data-layout="full">
                        <div data-align="auto"
                            class="form-buttons-wrapper form-buttons-auto   jsTest-button-wrapperField"><button
                                ...
                                onclick="window.location.href='{{ route('view_page_two') }}'">Next</button></div>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <script>
            ...
            value="241695007511452" />
        <script type="text/javascript">
            var all_spc = document.querySelectorAll("form[id='241695007511452'] .si" + "mple" + "_spc");
            for (var i = 0; i < all_spc.length; i++) {
                all_spc[i].value = "241695007511452-241695007511452";
            }
        </script>
    </form>
</body>
