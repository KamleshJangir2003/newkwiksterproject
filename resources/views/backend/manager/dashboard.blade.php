                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4 text-white"><span
                                                class="counter-value"
                                                data-target="{{ isset($total_form) ? count($total_form) : 0 }}
                                            ">0</span>
                                        </h4>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4 text-white"><span
                                                class="counter-value"
                                                data-target="{{ isset($total_pipeline) ? count($total_pipeline) : 0 }}">0</span>
                                        </h4>
                                    </div>
                                </div>
                            </div><!-- end card body -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4 text-white"><span
                                                class="counter-value"
                                                data-target="{{ isset($total_form_daily) ? count($total_form_daily) : 0 }}">0</span>
                                        </h4>
                                    </div>
                                </div>
                            </div><!-- end card body -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4 text-white"><span
                                                class="counter-value"
                                                data-target="{{ isset($total_pipeline_daily) ? count($total_pipeline_daily) : 0 }}">0</span>
                                        </h4>
                                    </div>
                                </div>
                            </div><!-- end card body -->
