...
<head>
    ...
    <meta charset="utf-8" />
    <title>Client Panel | Sign Up</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Get your free Client Panel now</p>
                                </div>
                                @if (session('success'))
                                ...
                                @endif
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" novalidate action="{{ route('client.register') }}"
                                        method="POST">
                                        @csrf
                                        <div class="mb-3">
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Already have an account ? <a href="{{ route('client.panel.login') }}"
                                    class="fw-semibold text-primary text-decoration-underline"> Log In </a> </p>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                ...
                                </script> Kwikster. Made with <i class="mdi mdi-heart text-danger"></i>
                                by <a href="https://wizifytechnologies.com/">Wizify Technologies</a>
                            </p>
                        </div>
                    </div>
                </div>
