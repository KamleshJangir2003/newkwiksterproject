...
<div class="row">
    ...
    font-size: 20px;">{{count($total_approve)}}/{{count($total_decline)}}</p>
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4 text-white"><span class="counter-value"
                                            data-target="{{count($total_form)}}">0</span>
                                    </h4>
                                </div>
                            </div>
                        </div><!-- end card body -->
            ...
            <div class="row">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                            data-target="{{count($total_client_form)}}">0</span>
                                    </h4>
                                </div>
                            </div>
                        </div><!-- end card body -->
                ...
                <div class="col-xl-3 col-md-6">
                    <!-- card -->
                    <div class="card card-animate bg-warning-subtle bg-gradient">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 overflow-hidden">
                                    <p class="text-uppercase fw-medium text-truncate mb-0">
                ...
                <div class="col-xl-3 col-md-6">
                    <!-- card -->
                    <div class="card card-animate bg-primary-subtle bg-gradient">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 overflow-hidden">
                                    <p class="text-uppercase fw-medium text-truncate mb-0">
                ...
                <div class="col-xl-3 col-md-6">
                    <!-- card -->
                    <div class="card card-animate bg-info-subtle bg-gradient">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 overflow-hidden">
                                    <p class="text-uppercase fw-medium text-truncate mb-0">
                    ...
                    <div class="card card-animate bg-danger bg-gradient">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="fs-14 mb-0 text-white">
                                    <i class="ri-arrow-right-up-line fs-13 align-middle"></i>
                                    Client Panel
                                </h5>
                            </div>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card card-animate bg-primary bg-gradient">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4 text-white">0{{count($total_approve)}}/0{{count($total_decline)}}
                                    </h4>
                                </div>
                            </div>
                        </div><!-- end card body -->
