                                        ...
                                        @foreach ($datas as $excelDataCollection)
                                            @foreach ($excelDataCollection as $data)
                                                <tr class="data-select-cursor">
                                                    ...
                                                    <td class="phone data-select" data-id="{{ $data->id }}">{{ $data->phone }}</td>
                                                    <td class="company_name data-select" data-id="{{ $data->id }}">{{ $data->company_rep1 }}</td>
                                                    <td class="location data-select" data-id="{{ $data->id }}">{{ $data->business_address }}</td>
                                                    <td class="location data-select" data-id="{{ $data->id }}">{{ $data->business_city }}</td>
                                                    <td class="location data-select" data-id="{{ $data->id }}">{{ $data->business_state }}</td>
                                                    <td class="phone data-select" data-id="{{ $data->id }}">{{ $data->business_zip }}</td>
