...
@section('content')
    ...
    <!-- end page title -->
    <form action="{{ route('manager.fwd.data.agent.again') }}" method="post">
        @csrf
        <div class="row">
            <div class="col-lg-12">
                                ...
                                <table class="table align-middle" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        @foreach ($datas as $data)
                                            <tr class="data-select-cursor @if($data->form_status=='DND') bg-warning text-white @endif"  data-date="{{ \Carbon\Carbon::parse($data->created_at)->format('d-m-y') }}">
                                                <th scope="row">
                                                    <div class="form-check">
                                                        <input class="form-check-input data-checkbox" type="checkbox"
                                                ...
                                                <td class="data-select name" data-id="{{ $data->id }}">
