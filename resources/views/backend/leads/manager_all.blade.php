                ...
                <div class="card" id="leadsList">
                    <div class="card-header border-0">
                        ...
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-sm-3">
                               <div><b>Total Leads</b> : {{count($datas)}}</div>
                            </div>
...
title="Delete Duplicate Entry."><i class="ri-delete-bin-fill align-bottom me-1"></i>Duplicate</a>
 <a class="btn btn-warning" href="{{url('manager/delete/dnd/entry')}}" onclick="return confirm('Are you sure ?');" data-bs-toggle="tooltip"
                    ...
                    <div class="card-body">
                        <div>
                            <div class="table-responsive table-card">
                                <table class="table align-middle phoneTable" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        @foreach ($datas as $data)
                                            <tr class="data-select-cursor @if ($data->is_dnd) bg-warning @endif">
                                                <th scope="row">
                                                    <div class="form-check">
                                                        <input class="form-check-input data-checkbox" type="checkbox"
                                                ...
                                                <td style="width: 150px;" class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item"
                                                            href="{{ route('manager.change.form_status', [($data_id = $data->id), ($form_status = 'Voice Mail'), ($form_status_value = '100')]) }}">Voice
                                                            Mail</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('manager.change.form_status', [($data_id = $data->id), ($form_status = 'Not Intrested'), ($form_status_value = '100')]) }}">Not
                                                            Intrested</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('manager.change.form_status', [($data_id = $data->id), ($form_status = 'Not Connected'), ($form_status_value = '100')]) }}">Not
                                                            Connected</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('manager.change.form_status', [($data_id = $data->id), ($form_status = 'Wrong Number'), ($form_status_value = '100')]) }}">Wrong
                                                            Number</a>
                                                        <a class="dropdown-item"
                                                                href="{{ route('manager.change.form_status', [($data_id = $data->id), ($form_status = 'WON'), ($form_status_value = '100')]) }}">WON</a>
                                                        <a class="dropdown-item"
                                                                href="{{ route('manager.change.form_status', [($data_id = $data->id), ($form_status = 'DND'), ($form_status_value = '100')]) }}">DND</a>
                                                    </div>
                                                </td>
                                                <td class="date">
                                                    ...
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            <a class="remove-item-btn"
                                                                href="{{ route('delete.lead', $data->id) }}"
...
@section('js')
    ...
    $('.phoneTable tbody tr').each(function() {
      ...
      // Check if the phone number has been seen before
