...
<html lang="en">
  ...
  <body>
    <div class="loginBox"> <img class="user"
        src="https://i.ibb.co/yVGxFPR/2.png" height="100px" width="100px">
      <h3>Sign in here</h3>
      <form action="#">
        @csrf
        ...
        <div class="inputBox"> <input id="uname" type="text" name="email"
            placeholder="Enter Your Email"> <input id="pass" type="password"
            name="password" placeholder="Password"> </div> <input type="submit"
          name value="Login">
      </form>
    </div>
    <script
