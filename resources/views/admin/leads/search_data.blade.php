                                                        ...
                                                        @if ($datas->isNotEmpty())
                                                            ...
                                                            @foreach ($datas as $data)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th  onclick="window.location.href='{{ route('view_lead_details', base64_encode($data->id)) }}'" style="cursor: pointer;"><span style="background-color: green;color:white;padding:10px"> View</span></th>
