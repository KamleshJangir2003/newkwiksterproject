                                ...
                                <div class="card" id="leadsList">
                                    <div class="card-header border-0">
                                        ...
                                        <div class="row g-4 align-items-center">
                                            ...
                                            <button type="button"  class=" btn-danger" onclick="window.location.href='{{route('interstedleads')}}'"><i class="fa-solid fa-circle-xmark"></i>clear</button>
                                    ...
                                    <div class="modal fade" id="submit_leads" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLongTitle">Interested lead</h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                            ...
                                                            @foreach ($datas as $data)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="clickable-cell" data-bs-toggle="modal" data-company-name="{{ $data->company_name }}"
                                                                        ...
                                                                        data-file5="{{ $data->file5 }}" data-file6="{{ $data->file6 }}" data-redmark="{{ $data->red_mark }}" data-error_file="{{ $data->error_file }}"
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="row border-end ">
                                    ...
                                    <div class="row unit2" id="unit22" style="display: none; border-top:#cccccc 1px solid" >
                                        <div class="col-6">
                                            <div class="mb-3">
                                    ...
                                    <div class="row unit3" id="unit33" style="display: none; border-top:#cccccc 1px solid"">
                                    ...
                                    <div class="row unit4" id="unit44" style="display: none; border-top:#cccccc 1px solid"">
                                    ...
                                    <div class="row unit5" id="unit55" style="display: none; border-top:#cccccc 1px solid"">
                                        <div class="col-6">
                                            <div class="mb-3">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="redmark" id="redmark" value="1" class="form-check-input">
                                               Red Mark
                                            </label>
                                        </div>
                                    </div><!--end col-->
    ...
    <script>
        $(document).ready(function() {
            $('#exampleFullScreenModal').on('show.bs.modal', function(event) {
                ...
                if (td.data('is_cover_well')) {
            $('#coverwell').prop('checked', true);
        } else {
            $('#coverwell').prop('checked', false);
        }
        if (td.data('redmark')) {
            $('#redmark').prop('checked', true);
        } else {
            $('#redmark').prop('checked', false);
        }
        // Display PDF
