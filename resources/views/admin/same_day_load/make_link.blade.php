...
<body>
    ...
    <div class="container">
        ...
        <p>Prepared for <input type="text" class="input-field" name="name1"  id="name1" style="border:none;border-bottom: #000 solid 1px"></p>
        <p>Created by Same Day Loads Dispatch Agency, LLC</p>

        <p>This agreement made as of this <input type="text" class="input-field" name="name2"  id="name2"
                style="border:none;border-bottom: #000 solid 1px;width:50px">day of <input type="text"
                class="input-field" name="name3"  id="name3" style="border:none;border-bottom: #000 solid 1px;width:50px"> , 2024 , by and
            between Same Day Loads Dispatch Agency, LLC hereinafter referred to as Dispatch and <input type="text"
                class="input-field" name="name4"  id="name4" style="border:none;border-bottom: #000 solid 1px">(Contact Name) of <input
                type="text" class="input-field" name="name5"  id="name5" style="border:none;border-bottom: #000 solid 1px">(Company Name),
        ...
        <p>Same Day Loads Dispatch Agency, LLC will charge carriers to as low as <input type="text" class="input-field" name="name6"  id="name6"
        ...
        <p>I,<input type="text" class="input-field" name="name7"  id="name7"
    ...
    <script>
        function generateLink() {
          ...
          const queryString = `name1=${encodeURIComponent(name1)}&name2=${encodeURIComponent(name2)}&name3=${encodeURIComponent(name3)}&name4=${encodeURIComponent(name4)}&name5=${encodeURIComponent(name5)}&name6=${encodeURIComponent(name6)}&name7=${encodeURIComponent(name7)}&name8=${encodeURIComponent(name8)}&name9=${encodeURIComponent(name9)}`;
        
          // Encode the query string in Base64
          const encodedString = btoa(queryString);
        
          // Generate the URL
          const url = `https://kwikinsurances.com/same-day-loads?data=${encodeURIComponent(encodedString)}`;
        
        
          // Display the URL in the console (for testing)
          console.log(url);
