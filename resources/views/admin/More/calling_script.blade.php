                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Calling script</h5>
                                        ...
                                        <div class="card m-b-20">
                                            ...
                                            <form action="{{route('store_script')}}" method="post">
                                                @csrf
                                                    ...
                                                    <textarea class="form-control" type="text" name="calling" id="editor">{{old('name') ? old('name') : $script->calling_script ??''}}</textarea>
