                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Intrested Data Summary || {{ $userDetails->alise_name}} ({{$agent->name}})</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <!-- Week 1 Sum -->
                                            <div class="col-md-3">
                                                <div class="card bg-light mb-3">
                                                    <div class="card-body">
                                                        <h6 class="card-title" style="text-align: center">Week 1</h6>
                                                        <hr>
                                                        <h6 class="card-text" style="text-align: center">{{ $week1Sum }}</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Week 2 Sum -->
                                            <div class="col-md-3">
                                                <div class="card bg-light mb-3">
                                                    <div class="card-body">
                                                        <h6 class="card-title" style="text-align: center">Week 2</h6>
                                                        <hr>
                                                        <h6 class="card-text" style="text-align: center">{{ $week2Sum }}</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Week 3 Sum -->
                                            <div class="col-md-3">
                                                <div class="card bg-light mb-3">
                                                    <div class="card-body">
                                                        <h6 class="card-title" style="text-align: center">Week 3</h6>
                                                        <hr>
                                                        <h6 class="card-text" style="text-align: center">{{ $week3Sum }}</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Week 4 Sum -->
                                            <div class="col-md-3">
                                                <div class="card bg-light mb-3">
                                                    <div class="card-body">
                                                        <h6 class="card-title" style="text-align: center">Week 4</h6>
                                                        <hr>
                                                        <h6 class="card-text" style="text-align: center">{{ $week4Sum }}</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Month Sum -->
                                            <div class="col-md-12">
                                                <div class="card bg-info text-white">
                                                    <div class="card-body">
                                                        ...
                                                        <h6 class="card-text">{{ $monthSum }}</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                                ...
                                                                @endphp
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div style="display:none"
                                                                            ...
                                                                            <p> Are you sure ..?</p>
                                                                            <a href="{{ route('remove_intrested', [base64_encode($data->id),base64_encode($agent->id)]) }}"
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="row border-end ">
                                    ...
                                    <div class="row unit2" id="unit22" style=" border-top:#cccccc 1px solid" >
                                        <div class="col-6">
                                            <div class="mb-3">
                                    ...
                                    <div class="row unit3" id="unit33" style=" border-top:#cccccc 1px solid"">
                                    ...
                                    <div class="row unit4" id="unit44" style=" border-top:#cccccc 1px solid"">
                                    ...
                                    <div class="row unit5" id="unit55" style=" border-top:#cccccc 1px solid"">
                                        <div class="col-6">
                                            <div class="mb-3">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <input type="hidden" name="verify_level" value="2">
                                    <div class="col-lg-12">
                                        <div class="text-end">
                                            <div class="mt-4">
