                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="page-header-title">
                            <h5 class="m-b-10">View Agents</h5>
                        </div>
                    </div>
                    <div class="col-md-4">
                                            ...
                                            @if (!empty($teamdetails))
                                                ...
                                                @foreach ($teamdetails as $team)
                                                    ...
                                                    <tr>
                                                        <th scope="row">{{ $a }}</th>
                                                        <td>{{ $team->name }}</td>
                                                        <td onclick="window.location.href='{{ route('edit_agent', $team->id) }}'">{{ $team->email }}</td>
                                                        <td>{{ $team->phone }}</td>
                                                        <td>{{ $team->new_pass }}</td>
                                                        ...
                                                        @if ($team->is_active == 1)
                                                            <td>
                                                                <a
                                                                    href="{{ route('UpdateajentStatus', ['active', base64_encode($team->id)]) }}">
                                                                    <div
                                                        ...
                                                        <td>
                                                            <div class="btn-group" id="btns<?php echo $a; ?>">
                                                                <a href="{{ route('update_ajent', ['id' => base64_encode($team->id)]) }}"
                                                            ...
                                                            <div style="display:none" id="cnfbox<?php echo $a; ?>">
                                                                ...
                                                                <a href="{{ route('deleteajent', base64_encode($team->id)) }}"
