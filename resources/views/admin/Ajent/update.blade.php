                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div id="content" class="content content-full-width">
                                                                        ...
                                                                        <div class="profile-header">
                                                                            ...
                                                                            <div class="profile-header-content">
                                                                                ...
                                                                                <div class="profile-header-info">
                                                                                    <h4 class="m-t-10 m-b-5" style="color:black">{{$profile->name}}</h4>
                                                                                    <p class="m-b-10"style="color:black">Agent</p>
                                                                                    @if($profile->is_active==1)
                                                                                    <a href="{{ route('UpdateajentStatus', ['active', base64_encode($profile->id)]) }}"
                                                                                        class="btn btn-xs btn-success">Active</a>
                                                                                        @else
                                                                                         <a href="{{ route('UpdateajentStatus', ['inactive', base64_encode($profile->id)]) }}"
                                                                    ...
                                                                    <div class="profile-content active" id="personal-details">
                                                                        <!-- begin tab-content -->
                                                                        <div class="tab-content p-0">
                                                                            ...
                                                                            <div class="tab-pane fade in active show"
                                                                                ...
                                                                                <div class="table-responsive">
                                                                                    <form
                                                                                        action="{{ route('update_ajent_process') }}"
                                                                                        method="post"
                                                                                        ...
                                                                                        <div class="form-group row">
                                                                                            <div class="col-sm-4 mt-2">
                                                                                                ...
                                                                                                <select class="form-control"
                                                                                                    ...
                                                                                                    <option value="A+"{{ $profile_data && $profile_data->blood == "A+" ? 'selected' : '' }}>A+</option>
                                                                                                    <option value="A-"{{ $profile_data && $profile_data->blood =="A-" ? 'selected' : '' }}>A-</option>
                                                                                                    <option value="B+"{{ $profile_data && $profile_data->blood =="B+" ? 'selected' : '' }}>B+</option>
                                                                                                    <option value="B-"{{ $profile_data && $profile_data->blood == "B-" ? 'selected' : '' }}>B-</option>
                                                                                                    <option value="AB+"{{ $profile_data && $profile_data->blood == "AB+" ? 'selected' : '' }}>AB+</option>
                                                                                                    <option value="AB-"{{ $profile_data && $profile_data->blood == "AB-" ? 'selected' : '' }}>AB-</option>
                                                                                                    <option value="O+"{{ $profile_data && $profile_data->blood == "O+" ? 'selected' : '' }}>O+</option>
                                                                                                    <option value="O-"{{ $profile_data && $profile_data->blood == "O-" ? 'selected' : '' }}>O-</option>
                                                                                            ...
                                                                                            <div class="col-sm-4 mt-2">
                                                                                                ...
                                                                                                <select
                                                                                                    ...
                                                                                                    <option value="1"{{ $profile_data && $profile_data->gender == 1 ? 'selected' : '' }}>
                                                                                                        Male</option>
                                                                                                    <option value="2"{{ $profile_data && $profile_data->gender == 2 ? 'selected' : '' }}>
                                                                                                        female</option>
                                                                                            ...
                                                                                            <div class="col-sm-4 mt-2">
                                                                                                ...
                                                                                                <select
                                                                                                    ...
                                                                                                    <option value="1"{{ $profile_data && $profile_data->marital == 1 ? 'selected' : '' }}>
                                                                                                        Married</option>
                                                                                                    <option value="2"{{ $profile_data && $profile_data->marital == 2 ? 'selected' : '' }}>
                                                                                                        Unmarried</option>
                                                                    ...
                                                                    <div class="profile-content" id="current-employment">
                                                                        ...
                                                                        <div class="tab-content p-0">
                                                                            ...
                                                                            <div class="tab-pane fade in active show" id>
                                                                                ...
                                                                                <div class="table-responsive">
                                                                                    <form
                                                                                        action="{{ route('update_current_ajent') }}"
                                                                                        method="post"
                                                                                        enctype="multipart/form-data">
                                                                                        @csrf
                                                                                        <div class="form-group row">
                                                                   ...
                                                                   <div class="profile-content" id="identity_proofs">
                                                                        ...
                                                                        <div class="tab-content p-0">
                                                                            ...
                                                                            <div class="tab-pane fade in active show" id>
                                                                                ...
                                                                                <div class="table-responsive">
                                                                                    <form
                                                                                        action="{{ route('update_identety_ajent') }}"
                                                                                        method="post"
                                                                                        enctype="multipart/form-data">
                                                                                        @csrf
                                                                                        <div class="form-group row">
                                                                                            ...
                                                                                            <div class="col-sm-4">
                                                                                                ...
                                                                                                @if(!empty($identety->marksheet))
                                                                                                <a href="{{url($identety->marksheet)}}" target="_blank">
                                                                                                 <img src="{{url($identety->marksheet)}}" width="50px" height="50px" alt="driving Card Image">
                                                                                             </a>
                                                                                                @else
                                                                                                <p>no image</p>
                                                                                                @endif
                                                                                            ...
                                                                                            <div class="col-sm-4">
                                                                                                ...
                                                                                                @if(!empty($identety->resume))
                                                                                                <a href="{{url($identety->resume)}}" target="_blank">
                                                                                                 <img src="{{url($identety->resume)}}" width="50px" height="50px" alt="driving Card Image">
                                                                                             </a>
                                                                                                @else
                                                                                                <p>no image</p>
                                                                                                @endif
                                                                                            ...
                                                                                            <div class="col-sm-4">
                                                                                                <div class="form-floating">
                                                                                                    <div class="form-check mt-2">
                                                                                                        <label class="form-check-label" for="verify" style="margin-right: 30px">Verify</label>
                                                                                                        <input class="form-check-input" type="checkbox" id="verify" name="verify" 
                                                                                                                @if(!empty($identety) && $identety->is_active == 1) checked @endif>
                                                                                                    </div>
                                                                                        </div>
                                                                                            </div>
                                                                                        </div>
                                                                    ...
                                                                    <div class="profile-content" id="salary_details">
                                                                        ...
                                                                        <div class="tab-content p-0">
                                                                            ...
                                                                            <div class="tab-pane fade in active show" id>
                                                                                ...
                                                                                <div class="table-responsive">
                                                                                    <form
                                                                                        action="{{ route('update_salary_ajent') }}"
                                                                                        method="post"
                                                                                        enctype="multipart/form-data">
                                                                                        @csrf
                                                                                        <div class="form-group row">
                                                                                                ...
                                                                                                <div class="form-floating">
                                                                                                    <div class="form-check mt-2">
                                                                                                        <input class="form-check-input"
                                                                                                               ...
                                                                                                               id="from_office"
                                                                                                               value="1"
                                                                                                               {{ isset($profile) && $profile->ip_check == 1 ? 'checked' : '' }}
                                                                                                               >
                                                                                                        <label class="form-check-label" for="from_office">
                                                                                                            From office
                                                                                                        </label>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="form-floating">
                                                                                                    <div class="form-check mt-2">
                                                                                                        <input class="form-check-input"
                                                                                                               ...
                                                                                                               id="from_Anywhere"
                                                                                                               value="2"
                                                                                                               {{ isset($profile) && $profile->ip_check == 2 ? 'checked' : '' }}
                                                                                                               >
                                                                                                        <label class="form-check-label" for="from_Anywhere">
                                                                                                            From Anywhere
                                                                                                        </label>
                                                                                                    </div>
                                                                    ...
                                                                    <div class="profile-content" id="bank_details">
                                                                        <!-- begin tab-content -->
                                                                        <div class="tab-content p-0">
                                                                            ...
                                                                            <div class="tab-pane fade in active show" id>
                                                                                ...
                                                                                <div class="table-responsive">
                                                                                    <form
                                                                                        action="{{ route('update_bank_ajent') }}"
                                                                                        method="post"
                                                                                        enctype="multipart/form-data">
                                                                                        @csrf
                                                                                        <div class="form-group row">
