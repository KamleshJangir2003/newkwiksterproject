...
<body>
    <form action="{{ route('kwikload_three_store', $id) }}" method="post" enctype="multipart/form-data"
        id="signature-form">
        @csrf
        <div role="main" class="form-all">
            <ul class="form-section page-section">
                ...
                <li class="form-line" data-type="control_fullname" id="id_3">
                    <p>Welcome to Kwik load Transport. Your company
                ...
                <li class="form-line " data-type="control_phone" id="id_4">
                    ...
                    <ul style="padding-left:0px">
                        <li>Completed W-9 a blank W-9 has been included for your convenience</li>
                        <li>Copy of MC Authority Document</li>
                        <li>Certificate of Insurance: One (1) Million Auto Liability or $100,000 Cargo Insurance
                           </li>
                        <li>Drivers First and Last name</li>
                        <li>Copy of CDL Licenses or Drivers Licenses</li>
                        <li>State Inspections Report</li>
                        <li>IFTA stickers & document</li>
                        <li>Truck Registration</li>
                        <li>ELD Access granted to Dispatch Team</li>
                    </ul>
                </li>
                ...
                <li class="form-line" data-type="control_number" id="id_15">
                    <ul style="list-style-type: none; padding-left: 0;">
                        ...
                        <li style="margin-bottom: 10px;">
                            VIN Number: <input type="text" name="vin"
                                style="border: none; border-bottom: 1px solid black; width: 200px; text-align: center;"
                                required />
                        </li>
                        <li style="margin-bottom: 10px;">
                            License Plate Number: <input type="text" name="license_plate"
                                style="border: none; border-bottom: 1px solid black; width: 200px; text-align: center;"
                                required />
                        </li>
                    </ul>
                ...
                <li class="form-line " data-type="control_phone" id="id_4">
                    ...
                    <ul style="padding-left:0px">
                        <li style="list-style-type: none; text-decoration: none;"><strong>Weekly Payment
                                Breakdown:</strong></li><br>
                        <li style="list-style-type: none; text-decoration: none;">=8% Owner-Operator Lease on Fee</li>
                        <!--<li>Owner Operators will be paid weekly 8 days from start date</li>-->
                        <li>Owner Operator can get paid with a quick pay within 72 hrs of load completion for 2.7% - 6%</li>
                    </ul>
                </li>
                <p>All payments will be sent thru Zelle or CashApp</p>
                <li class="form-line " data-type="control_phone" id="id_4">
                    <p><strong>Lease On Policies:</strong></p>
                    <ul style="padding-left:0px">
                        <!--<li>All trucks must be covered with owner operator’s insurance with the certificate holder on-->
                        <!--    COI for kwik load Transport-->
                        <!--</li>-->
                        <li>All minor and major accidents will be Wiley responsible for the owner operator during the
                            lease on program.</li>
                        <li>Any tickets, fines, tolls, will be reported to owner operator who will be 100% responsible
                            for any traffic or vehicle violations</li>
                        <li>Any fines from DOT or FMCSA that is reported from owner operator’s truck will held
                            responsible for the owner operator
                        </li>
                    </ul>
                </li>
                <p>Any driver negligence such as not completing a load, abandonment of truck, obligations,
                    driving mishaps such as getting stuck under bridges, jack-knifing, not completing routine
                    inspections, etc., could result in fines or deductions from pay due by the driver.</p>
                <p>The expectations of this position are for all drivers to be responsible for completing on-time
                    deliveries and complying with company’s requirements. In the event of an emergency, please
                    see Drivers Handbook.</p>
                <p>All Owner-Operators must take a picture of MC sign and send it to the company group chat. MC signs
                    must be placed on the side of the truck at all times.</p>
