...
<body>
    <form class="jotform-form" action="#" method="post" accept-charset="utf-8" autocomplete="on">
        <div id="formCoverLogo" style="margin-bottom:32px"
            ...
            <div class="form-page-cover-image-wrapper" style="max-width:300px">
                <img src="{{asset('Agent/kwikload-logo.png')}}"
                    class="form-page-cover-image" width="160" height="160" aria-label="Form Logo"
                    style="aspect-ratio:380/160" />
            </div>
            <div class="header-content" style="text-align: center">
                <p><strong>website : <a href="https://kwikinsurances.com/load" target="_blank"
                            rel="nofollow">https://kwikinsurances.com/load</a></strong></p>
                ...
                <li id="cid_41" class="form-input-wide" data-type="control_head">
                    <div class="form-header-group  header-default">
                        <div class="header-text httac htvam">
                            <h2 id="header_41" class="form-header" data-component="header">Kwik Load Freight
                                Management LLC</h2>
                            <div id="subHeader_41" class="form-subHeader">Alexandria, VA, 22306</div>
                        </div>
                    </div>
                </li>
                <li class="form-line" data-type="control_text" id="id_43">
                    <div id="cid_43" class="form-input-wide" data-layout="full">
                        <div id="text_43" class="form-html" data-component="text" tabindex="0">
                            <p><br /><strong>I am Shawn
                                    Bakers."I am your dedicated personal assistant specializing in facilitating the
                                    onboarding process for Trucking Load."</strong><br /><strong>My desk number is (786) 850-8089.<br /><br />Booking loads for a new trucking authority can be challenging.
                                    First, not many brokers want to work with brand-new trucking companies because they
                                    don’t yet have a track record for reliability and safety. Second, if you’re new to
                                    the business, the number of options, data, and pressure to book can be
                                    overwhelming.|<br /><br />"Trucking Load: Streamlined logistics solutions tailored
                    ...
                    <div class="form-input-wide" data-layout="full">
                        <div data-align="auto"
                            class="form-buttons-wrapper form-buttons-auto   jsTest-button-wrapperField"><button
                                ...
                                onclick="window.location.href='{{ route('kwikload_page_two') }}'">Next</button></div>
                    </div>
                </li>
            </ul>
        </div>
