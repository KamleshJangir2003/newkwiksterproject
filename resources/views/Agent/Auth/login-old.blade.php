...
<head>
    ...
    <link rel="canonical" href="https://codepen.io/hugo/pen/AvyzVg">
...
<body translate="no">
    <div id="logo">
        <h1><i>KWIK-INSURANCE AGENT LOGIN</i></h1>
    </div>
    <section class="stark-login">
        <form action="{{ route('ajent_login_process') }}" method="post">
            @csrf
            <div id="fade-box">
                <input type="text" name="email" id="username" placeholder="Username" value="{{ old('email') }}"
                    required>
                @error('email')
