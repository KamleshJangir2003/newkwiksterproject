...
@keyframes wrong-log {
  ...
  <body>
    <div class="panda">
      ...
      <form action="{{ route('ajent_login_process') }}" method="post">
        @csrf
        <div id="fade-box">
            <!-- Panda Hands for Visual Effect -->
            <div class="hand"></div>
            <div class="hand rgt"></div>
    
            <h4>KWIK-INSURANCE AGENT LOGIN</h4>
    
            <!-- Username Field -->
            <div class="form-group">
                <input type="text" name="email" id="username" placeholder="Email" value="{{ old('email') }}" required class="form-control"/>
            ...
            <!-- Hidden fields for location (latitude, longitude) -->
