                    ...
                    <div class="col-12">
                        <div class="card m-b-20">
                            <form action="{{ route('store_all_script') }}" method="post">
                                @csrf
                                <h4 style="text-align: center">Email Script</h4>
                                <textarea class="form-control" height="500px" type="text" name="email" id="editor">{{ old('name') ? old('name') : $script->email_script ?? '' }}</textarea>
