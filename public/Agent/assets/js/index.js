...
// chart 2
 ...
 var ctx = document.getElementById("chart2").getContext('2d');
  ...
  var gradientStroke3 = ctx.createLinearGradient(0, 0, 0, 300);
	...
	var gradientStroke4 = ctx.createLinearGradient(0, 0, 0, 300);
      ...
      var totalForms = formData.totalForms;
      var pipelineCall = formData.pipelineCall;
      var intrestedCall = formData.intrestedCall;
      var won = formData.won;

      var myChart = new Chart(ctx, {
        type: 'doughnut',
        data: {
          labels: ["Error Forms", "Pipelines", "Intersted", "Calls"],
          datasets: [{
            backgroundColor: [
              gradientStroke1,
              gradientStroke2,
            ...
            data: [totalForms, pipelineCall, intrestedCall, won],
			borderWidth: [1, 1, 1, 1]
          }]
        },
        options: {
 ...
 //chart monthaly  
 var ctx = document.getElementById("chartmonthaly").getContext('2d');
 ...
 var gradientStroke4 = ctx.createLinearGradient(0, 0, 0, 300);
     ...
     var month_forms = formData.month_forms;
     var month_pipeline = formData.month_pipeline;
     var month_intrested = formData.month_intrested;
     var month_won = formData.month_won;
     ...
     var myChart = new Chart(ctx, {
       ...
       data: {
         ...
         datasets: [{
           ...
           data: [month_forms, month_pipeline, month_intrested, month_won],
     borderWidth: [1, 1, 1, 1]
         }]
       },
       options: {
